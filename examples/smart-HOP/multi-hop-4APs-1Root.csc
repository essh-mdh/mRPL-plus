...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>71.35124795957987</x>
        <y>64.41912204431365</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>91.23347888415034</x>
        <y>31.56798949006887</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>5.980133676953681</x>
        <y>92.86048442305328</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>47.972209422590076</x>
        <y>32.21050699796763</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>11.05817171452742</x>
        <y>24.50959793609241</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>43.07775224451497</x>
        <y>23.119487806606077</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>4.1374009649711345 0.0 0.0 4.1374009649711345 -7.105847209320915 -66.927824510159</viewport>
    </plugin_config>
    <width>400</width>
    <z>6</z>
    <height>400</height>
  ...
  <plugin>
    Mobility
    <plugin_config>
      <positions EXPORT="copy">/home/daniel/Simulation Contiki-master/1MN_4APs_1Root/1MN_4APs_1Root_positions</positions>
    </plugin_config>
    <width>500</width>
    <z>3</z>
    <height>200</height>
...
TIMEOUT(300000, log.log("last msg: " + msg + "\n")); /* milliseconds. print last msg at timeout */</script>
      <active>true</active>
    </plugin_config>
    <width>600</width>
    <z>0</z>
